# Generated by Django 4.1.1 on 2025-02-18 02:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Orders', '0016_ordercontent_subcat'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_stage', models.CharField(default='noenvio', max_length=60)),
                ('order_status', models.BooleanField(default=False)),
                ('blocked', models.BooleanField(default=False)),
                ('family', models.CharField(blank=True, max_length=20, null=True)),
                ('subcat', models.CharField(blank=True, max_length=20, null=True)),
